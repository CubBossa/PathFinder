package main.de.bossascrew.pathfinder.inventories;
...
import main.de.bossascrew.pathfinder.system.Edge;
...
public class InventoryNodeEditor extends InventoryManager {
	...
	public void refresh() {
		...
		inv.setItem(1, setMetaTag(createItem(Material.BARRIER, "§cNode löschen", 1), NODE_ACTION_KEY, NODE_ACTION_VALUE_DELETE));
		inv.setItem(3, setMetaTag(createItem(Material.LEAD, "§aTangenten stärke", 1, "§7Aktuelle Tangentenwichtung: §a" + n.tangentReach), NODE_ACTION_KEY, NODE_ACTION_VALUE_TANGENT));
