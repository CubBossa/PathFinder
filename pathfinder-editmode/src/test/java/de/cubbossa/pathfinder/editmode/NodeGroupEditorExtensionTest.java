...
class NodeGroupEditorExtensionTest {
  ...
  public void checkVersion1() {
    ...
    assertThrows(UnknownDependencyException.class,
        () -> roadMapEditorExtension.checkVersion("1.19", "4.8"));
  }
...
//    RoadMapEditorExtension roadMapEditorExtension = new RoadMapEditorExtension();
//    assertThrows(UnknownDependencyException.class,
//        () -> roadMapEditorExtension.checkVersion("1.19.1", "5.0.0-SNAPSHOT-b700"));
//  }
//
//  @Test
...
//    RoadMapEditorExtension roadMapEditorExtension = new RoadMapEditorExtension();
//    assertThrows(UnknownDependencyException.class,
//        () -> roadMapEditorExtension.checkVersion("1.19.3", "5.0.0-SNAPSHOT-b120"));
//  }
