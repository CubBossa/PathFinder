...
public class PathfinderSearchTerms extends TableImpl<PathfinderSearchTermsRecord> {
   ...
   */
  public final TableField<PathfinderSearchTermsRecord, NamespacedKey> GROUP_KEY =
      createField(DSL.name("group_key"), SQLDataType.VARCHAR.nullable(false), this, "",
          new NamespacedKeyConverter());
  /**
   * The column <code>pathfinder_search_terms.search_term</code>.
   */
  public final TableField<PathfinderSearchTermsRecord, String> SEARCH_TERM =
      createField(DSL.name("search_term"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public <O extends Record> PathfinderSearchTerms(Table<O> child,
                                                  ForeignKey<O, PathfinderSearchTermsRecord> key) {
  ...
  public List<ForeignKey<PathfinderSearchTermsRecord, ?>> getReferences() {
    return Arrays.asList(
        Keys.PATHFINDER_SEARCH_TERMS__FK_PATHFINDER_SEARCH_TERMS_PATHFINDER_NODEGROUPS__PK);
  }
  ...
  public PathfinderNodegroups pathfinderNodegroups() {
    if (_pathfinderNodegroups == null) {
      _pathfinderNodegroups = new PathfinderNodegroups(this,
          Keys.PATHFINDER_SEARCH_TERMS__FK_PATHFINDER_SEARCH_TERMS_PATHFINDER_NODEGROUPS__PK);
    }
  ...
  public <U> SelectField<U> mapping(
      Function2<? super NamespacedKey, ? super String, ? extends U> from) {
