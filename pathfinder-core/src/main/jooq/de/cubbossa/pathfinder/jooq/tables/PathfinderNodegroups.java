...
public class PathfinderNodegroups extends TableImpl<PathfinderNodegroupsRecord> {
   ...
   */
  public final TableField<PathfinderNodegroupsRecord, NamespacedKey> KEY =
   ...
   */
  public final TableField<PathfinderNodegroupsRecord, Double> WEIGHT =
      createField(DSL.name("weight"),
          SQLDataType.DOUBLE.nullable(false).defaultValue(DSL.field("1", SQLDataType.DOUBLE)), this,
          "");
  ...
  public <O extends Record> PathfinderNodegroups(Table<O> child,
                                                 ForeignKey<O, PathfinderNodegroupsRecord> key) {
  ...
  public <U> SelectField<U> mapping(
      Function2<? super NamespacedKey, ? super Double, ? extends U> from) {
