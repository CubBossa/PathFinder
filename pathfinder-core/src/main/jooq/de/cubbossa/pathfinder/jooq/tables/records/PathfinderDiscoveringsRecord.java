...
public class PathfinderDiscoveringsRecord extends UpdatableRecordImpl<PathfinderDiscoveringsRecord>
    implements Record3<NamespacedKey, UUID, LocalDateTime> {
   ...
   */
  public PathfinderDiscoveringsRecord(NamespacedKey discoverKey, UUID playerId,
                                      LocalDateTime date) {
    super(PathfinderDiscoverings.PATHFINDER_DISCOVERINGS);
  ...
  @Override
  public PathfinderDiscoveringsRecord values(NamespacedKey value1, UUID value2,
