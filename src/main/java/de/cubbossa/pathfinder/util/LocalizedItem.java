...
public class LocalizedItem {
	...
	public LocalizedItem(ItemStack stack, Message name, TagResolver[] nameResolver, Message lore, TagResolver[] loreResolver) {
	...
	public ItemStack createItem(Player player) {
		...
		meta.setDisplayName(serializer.serialize(TranslationHandler.getInstance().translateLine(name, player, nameResolver)));
		meta.setLore(TranslationHandler.getInstance().translateLines(lore, player, loreResolver).stream().map(serializer::serialize).toList());
	...
	public static class Builder {
		...
		public LocalizedItem build() {
			return new LocalizedItem(stack, name, nameResolvers.toArray(TagResolver[]::new), lore, loreResolvers.toArray(TagResolver[]::new));
		}
